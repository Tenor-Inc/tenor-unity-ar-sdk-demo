...
public class UniGifImage : MonoBehaviour
{
    ...
    private void Update()
    {
        switch (nowState)
        {
            ...
            case State.Playing:
//				if (m_rawImage == null || m_gifTextureList == null || m_gifTextureList.Count <= 0 || m_texture == null)
//                {
//                    return;
//                }
				...
				render.material.mainTexture = m_gifTextureList[m_gifTextureIndex].m_texture2d;
...
//        }
		...
		render.material.mainTexture = m_gifTextureList[0].m_texture2d;
